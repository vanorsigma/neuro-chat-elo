...
import { RefreshingAuthProvider } from 'node:@twurple/auth';
import { ApiClient } from 'node:@twurple/api';
import { EventSubMiddleware } from 'node:@twurple/eventsub-http';
...
export function getTwitchMiddleware(env: Env): EventSubMiddleware {
    let middleware = new EventSubMiddleware({
